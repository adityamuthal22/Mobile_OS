//Create Custom Marathi Array functions
...
function myArray() {
  ...
  myArray.prototype.शीर्ष = function () {
      let index = this.length -1;
      // this[index] = value;
      console.log("Top of Array:-",a2[index]);
    };
    ...
    myArray.prototype.उलट=function(){
      ...
      console.log("Reverse array:-",a3)
    }
  
    myArray.prototype.आकार=function(){
     console.log( "length of array :-",a2.length);
    }
  a2.ढकल("a");
  a2.ढकल("b");
  a2.ढकल("c");
